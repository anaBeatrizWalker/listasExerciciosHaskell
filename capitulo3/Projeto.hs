...
-- >Pessoa {cargo = Estagiario, nome = "Ana Beatriz"}
--Pessoa {cargo = Estagiario, nome = "Ana Beatriz"}
-- >verSalario Pessoa {cargo = Estagiario, nome = "Ana Beatriz"}
--1500.0
-- >promover Pessoa {cargo = Estagiario, nome = "Ana Beatriz"}
--Pessoa {cargo = Programador, nome = "Ana Beatriz"}
--5750.15